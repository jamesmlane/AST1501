# ----------------------------------------------------------------------------
#
# TITLE - generate_triaxial_df_spiral_range.py
# AUTHOR - James Lane
# PROJECT - AST 1501
#
# ----------------------------------------------------------------------------
...
''' Script to run parallelized triaxial DF evaluation with spiral arms over a 
...
# General
_NAMES = ['_b090','_b095','_b105','_b110']	# Trailing names
