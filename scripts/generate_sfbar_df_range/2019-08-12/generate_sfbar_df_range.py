# ----------------------------------------------------------------------------
#
# TITLE - generate_sfbar_df_range.py
# AUTHOR - James Lane
# PROJECT - AST 1501
#
# ----------------------------------------------------------------------------
...
_SFBAR_RB = 5/8
_SFBAR_OMEGAB_RANGE = np.array([50,55,60])/(220/8)
_SFBAR_OMEGAB_RANGE_STR = np.array(['50','55','60'])
_SFBAR_AF_RANGE = np.array([0.010,0.015,0.020,0.025])
_SFBAR_AF_RANGE_STR = np.array(['010','015','020','025'])
...
for i in range( len(_SFBAR_OMEGAB_RANGE) ):
    for j in range( len(_SFBAR_AF_RANGE) ):
        
        # Make the log file
        output_str = '_OMEGAB_'+_SFBAR_OMEGAB_RANGE_STR[i]+'_AF_'+_SFBAR_AF_RANGE_STR[j]
