...
th_pas = np.arange(0,np.pi,0.1)

# Loop over each solution and plot the data
for i in range( len(th_pas) ):
    ...
    kt = ast1501.potential.kuijken_potential(b_a=0.8, phib=th_pas[i])
...
fig.savefig('halotest_solution_velocities.pdf')
