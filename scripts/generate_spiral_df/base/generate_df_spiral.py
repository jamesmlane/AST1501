# ----------------------------------------------------------------------------
#
# TITLE - generate_df_spiral_range.py
# AUTHOR - James Lane
# PROJECT - AST 1501
#
# ----------------------------------------------------------------------------
...
''' Script to run parallelized MWPotential2014 DF evaluation with spiral arms 
over a range of halo b values. Halo values run are b={0.9,0.95,1.05,1.1} in 
two separate runs.
'''
